...
DANTE'S BACKGROUND:
- 10+ years across B2B SaaS, enterprise software, fintech, data infrastructure, and healthcare IT
- Deep experience: Teamshares (lead designer, 0→1 product builds), Meroxa (principal designer, strategic pivot), Marketo (enterprise UX), MEDHOST (healthcare), T-Mobile (consumer), Upwork (contract)
- Strongest in: complex workflows, internal tools, design systems, 0-to-1 product work, cross-functional leadership, research-driven strategy
