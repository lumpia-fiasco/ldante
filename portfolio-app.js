...
const TAILORED = {
  ...
  yahoo: {
    ...
    body: "I'm Dante. I built Marketo Sky\u2019s design system from scratch \u2014 50+ components, full org adoption, governance that survived an Adobe acquisition and contributed patterns upstream to Spectrum.\n\nI also built this portfolio using Claude Code, which gives me a first-hand read on where design intent breaks down in AI-generated code. That gap is exactly what this role is about.",
