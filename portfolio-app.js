...
const TAILORED = {
  ...
  weedmaps: {
    ...
    body: "I'm Dante. I got my start in regulated products — patient registration at MEDHOST, where registrars and facility front desk staff had seen enough healthcare IT disasters that they didn't give new software the benefit of the doubt. You learn fast that when users arrive already skeptical, every confusing moment lands harder than it would anywhere else.\n\nCannabis has the same quality. The trust is harder-earned and a mediocre experience costs more. I've built two-sided platforms, led design systems through an acquisition, and I know what it takes to make a marketplace feel credible to both sides. This is the kind of moment I want to be building for.",
