...
const TAILORED = {
  ...
  weedmaps: {
    ...
    jd: "Staff Systems Design Engineer\nWeedmaps\n\nLead the evolution of Weedmaps' design system as a scalable, production-grade product unifying Design, Engineering, and AI tooling. Define multi-platform system architecture, governance, and scalability principles across web + mobile. Design and implement core components with intuitive, flexible APIs. Establish a best-in-class design-to-code pipeline (Figma, Claude, Builder.io). Introduce and standardize AI-assisted workflows. Partner with Engineering on CI/CD, token systems, and distribution infrastructure. Lead migration of legacy UI and drive adoption across the ecosystem. Mentor designers and engineers.\n\n7+ years front-end, design, or creative engineering with strong mobile focus (iOS/Android). Proven track record building and scaling design systems across multiple teams. Expertise in React and React Native. Familiarity with AI-assisted development tools. Strong systems thinking across Design, Engineering, and Creative. Experience with design-to-code pipelines and token systems.",
  },
  planhub: {
  ...
  housecallpro: {
    ...
    body: "I'm Dante. I've spent my career designing tools for people whose actual job is not using software. The pattern is always the same: they have somewhere better to be. Housecall Pro is that problem with real stakes — a plumbing pro between jobs doesn't have minutes to check the app, they have seconds.\n\nThe AI layer is where it gets genuinely interesting: automation that earns trust from someone who can't afford to be wrong. I built this portfolio with Claude Code. The AI-native expectation in your JD is current for me, not a direction I'm moving toward.",
...
const THOUGHTS = {
  ...
  'when-the-data-is-about-you': {
    kicker: 'Point of View',
    title:  'When the data is about you',
    dek: 'On designing financial products where the user is also the subject — and why that asymmetry changes everything about how you build trust.',
    sections: [
      {
        paragraphs: [
          'Financial data products have a quality that most products don’t: the subject and the consumer are the same person. When someone checks their credit score, they’re not browsing data — they’re looking at a number that describes them, generated by a system they didn’t choose, that will be used to make decisions about their life. The design problem isn’t just usability. It’s dignity.',
          'I’ve designed for financial consequence from the infrastructure side — payroll systems where an error costs someone their rent, data pipelines where a production failure means a team is blind at 2am, treasury flows where the product literally holds money. That work shapes how you think about stakes. The consumer side of financial data carries the same weight, differently distributed.',
        ],
      },
      {
        heading: 'The anxiety is the context',
        paragraphs: [
          'A person checking their credit score isn’t curious. They’re worried. Maybe they’re about to apply for a mortgage. Maybe they just got rejected for a loan and they’re trying to understand why. The emotional state they arrive in is not neutral, and the interface either respects that or ignores it.',
          'Designing for anxious users means front-loading clarity. The number first, then the explanation. The action first, then the context. The thing they came to see, immediately, without friction. Every extra step between the user and the information they need is a moment where anxiety compounds. That’s not just a UX principle — it’s a product trust decision.',
        ],
      },
      {
        heading: 'Legibility as a trust mechanism',
        paragraphs: [
          'If someone can’t understand their own financial data, they don’t feel informed — they feel more vulnerable. The opacity works against the product. Legibility isn’t a UX nicety here; it’s the core value proposition. A score they can read and explain. A factor breakdown that actually clarifies. A recommendation that leads somewhere real.',
          'I’ve worked on data-dense products where the temptation is to surface everything and let users find what they need. The alternative — the harder design problem — is deciding what matters most in this moment, for this user, and making that land clearly. That prioritization is the design work.',
        ],
      },
      {
        heading: 'Two audiences, one underlying system',
        paragraphs: [
          'Experian serves businesses (lenders, insurers, marketers) and consumers through the same data infrastructure. These audiences have fundamentally different relationships to the data. A lender wants precision and risk signal. A consumer wants understanding and agency. The same credit file reads completely differently depending on who’s looking at it and why.',
          'I’ve led design on two-sided platforms where coherence across personas was the central challenge — at Meroxa serving data engineers and platform operators, at Teamshares serving network operators and individual company leadership. The design discipline is the same: shared system, differentiated experiences, no drift between them that erodes the whole.',
        ],
      },
      {
        heading: 'What I’d bring to Experian',
        paragraphs: [
          'Financial consequence design, multi-persona platforms, and data products that have to be legible under pressure — that’s the work I’ve been doing. The consumer side of credit and financial data sits at the intersection of all three.',
          'I’d bring the craft, the systems thinking, and a specific empathy for users who arrive at a product already carrying something. That’s the design brief Experian’s consumer products are working inside, and it’s one I want to help answer.',
        ],
      },
    ],
  },
